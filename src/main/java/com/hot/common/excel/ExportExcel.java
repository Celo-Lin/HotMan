...
public class ExportExcel {
	...
	private void initialize(String title, List<String> headerList) {
		...
		// SXSSF（流式）默认不记录列内容，autoSizeColumn 前必须开启列追踪，否则会抛
		// IllegalStateException: Cannot get best fit column width on untracked column
	 ...
	 * @param lastCol 终止列
	 */
	public <E>ExportExcel setDroplist(String[] formulaString, int firstRow, int lastRow, int firstCol, int lastCol) {
