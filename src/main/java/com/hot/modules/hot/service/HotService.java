    ...
    public int save(Hot hot, String userid) throws Exception {
        ...
        if (basicyt != null) {
            ...
            if (basicyt.getHotsId() == null || basicyt.getHotsId().equals("")) {
                ...
                if (hb != null) {
                    if (id != null && !id.equals(hb.getHotId())) throw new Exception("YouTube渠道红人ID已存在");
        ...
        if (basicig != null) {
            ...
            if (basicig.getHotsId()== null || basicig.getHotsId().equals("")) {
                ...
                if (hb != null) {
                    if (id != null && !id.equals(hb.getHotId())) throw new Exception("Instagram渠道红人ID已存在");
        ...
        if (basictk != null) {
            ...
            if (basictk.getHotsId()== null || basictk.getHotsId().equals("")) {
                ...
                if (hb != null) {
                    if (id != null && !id.equals(hb.getHotId())) throw new Exception("TikTok渠道红人ID已存在");
